  ...
  return (
    <PortalShell roleLabel="Country Supervisor" navItems={SUPERVISOR_NAV_ITEMS}>
      ...
      <p className="text-midnight-900/55 font-light mb-10 max-w-2xl">
        Every candidate sourced by recruiters in your assigned country. Verify reported candidates or return them for
        correction with a reason — recruiter and country reassignment lives under Staff & Roles.
      </p>
      <CandidateList emptyLabel="No candidates in your assigned country yet." canVerify />
    </PortalShell>
  );
}
