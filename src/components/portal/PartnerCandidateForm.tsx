...
// Section 4's exact checklist — matches the Agency Application Form's own
// item order and "Required for: X" annotations (same list as the
// Candidate Information Form's, since Vertex's document requirements
// don't differ by intake path).
